#code for H2DCF stainings analysis (developmental zone stainings, leaves taken from plants kept for 2 days in growth chamber prior to staining)
...
setwd("C:/Users/Magdalena/Desktop/MAPS/Master_thesis/ROS/H2DCF_may/raw_results") #folder with all the Fiji raw results


datafiles <- list.files(path = "C:/Users/Magdalena/Desktop/MAPS/Master_thesis/ROS/H2DCF_may/raw_results") #listing all fines
...
setwd("C:/Users/Magdalena/Desktop/MAPS/Master_thesis/ROS/H2DCF_may")
...
setwd("C:/Users/Magdalena/Desktop/MAPS/Master_thesis/ROS/H2DCF_may/R_output")
write.csv(data_H2DCF_all, file = "data_H2DCF_raw_may.csv", quote = FALSE, 
          row.names = FALSE)
...
setwd("C:/Users/Magdalena/Desktop/MAPS/Master_thesis/ROS/H2DCF_may/R_output") 
data <- read.csv("data_H2DCF_raw_may.csv")
...
setwd("C:/Users/Magdalena/Desktop/MAPS/Master_thesis/ROS/H2DCF_may/R_output")
write.csv(data, file = "data_H2DCF_may_no_outliers.csv", quote = FALSE, 
          row.names = FALSE)
...
kruskal.test(Mean ~ Genotype, data = data_a)
kruskal.test(Mean ~ Genotype, data = data_b) 
kruskal.test(Mean ~ Genotype, data = data_c)
...
#if you are plotting on a later stage, load data in
setwd("C:/Users/Magdalena/Desktop/MAPS/Master_thesis/ROS/H2DCF_may/R_output")
data <- read.csv("data_H2DCF_may_no_outliers.csv")
...
#comparisons for the tests
comp_bdpox <- list(c("WT", "NaN1508 #9"), c("NaN1508 #9", "NaN1508 #3"), c("WT", "NaN1508 #3"))
...
#plot
H2DCF_plot_mean_intensity <- ggplot(data, aes(Genotype, Mean)) +
...
H2DCF_plot_mean_intensity


#no labels
H2DCF_plot2 <- ggplot(data, aes(Genotype, Mean)) +
  facet_grid(.~factor(Stage, levels = c("early stage 6", "middle stage 6", "late stage 6"))) +
  geom_boxplot(aes(colour = Genotype, fill = Genotype), alpha = 0.3, 
               lwd = 1,
               outlier.shape = NA) + 
...
pdf("H2DCF_nowalking_combined.pdf", height = 10, width= 16)
print(H2DCF_plot2, device=cairo_pdf)
dev.off()
...
setwd("C:/Users/Magdalena/Desktop/MAPS/Master_thesis/ROS/H2DCF_may/plots")

pdf("H2DCF_may_byday2.pdf", height = 35, width= 15)
